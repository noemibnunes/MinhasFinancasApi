...
public class UsuarioServiceTest {
	...
	public void naoDeveSalvarUmUsuarioComEmailJaCadastrado() {
		...
		org.junit.jupiter.api.Assertions
			.assertThrows(RegraNegocioException.class, () -> service.cadastrarUsuario(usuario) ) ;
	...
	public void deveAutenticarUmUsuarioComSucesso() {
		...
		//acao
		Usuario result = service.autenticarUsuario(email, senha);
	...
	public void deveLancarErroQUandoNaoEncontrarUsuarioCadastradoComOEmailInformado() {
		...
		//acao
		Throwable exception = Assertions.catchThrowable( () -> service.autenticarUsuario("email@email.com", "senha") );
	...
	public void deveLancarErroQuandoSenhaNaoBater() {
		...
		//acao
		Throwable exception = Assertions.catchThrowable( () ->  service.autenticarUsuario("email@email.com", "123") );
